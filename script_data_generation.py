...
def parametter_fitting_data():
    ...
    # #parameter fitting with bistability conditions 
    # bounds = [(0, 100),(0, 100), (0,1), (0,100), (0, 100), (0,3)]  # bounds for: μ_p, μ_b, μ_r, σ_p, σ_b, σ_r (in this order)
    # parameter_fitting(bounds, "data/estimated_parameters_bistability_13.npy", bistability_check=True)

    #parameter fitting with bistability conditions 
    bounds = [(0, 100),(0, 100), (0,100), (0,100), (0, 100), (0,100)]  # bounds for: μ_p, μ_b, μ_r, σ_p, σ_b, σ_r (in this order)
    parameter_fitting(bounds, "data/estimated_parameters_bistability_100.npy", bistability_check=True)
